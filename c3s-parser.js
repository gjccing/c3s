  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c2 = function(first, next) {
            return [first].concat( next.map( n => n[3] ) );
          },
        peg$c3 = function(c, sel) {
            if ( c )
              sel.unshift(c);

            return sel;
          },
        peg$c4 = function(first, next) {
            var result = next.reduce((p,c)=>{
              p.push(c[0], c[2]);
              return p;
            },[]);
        ...
        peg$c13 = function() {
            var val = text().trim();
            return new Combinator(val?val:" ");
          },
        peg$c14 = function(compound) {
        ...
        peg$c17 = function() {
            var type = text();
            if ( jsTypeList.indexOf( type ) > -1 )
              return type;
            else
              throw new TypeError(`${type} is not javascript type.`);
          },
        peg$c18 = "#",
        ...
        peg$c28 = function(name, exp) {
            return new Attribute(name, exp[0], exp[2], exp[4]);
          },
        peg$c29 = "=",
        ...
        peg$c55 = "NaN",
        peg$c56 = { type: "literal", value: "NaN", description: "\"NaN\"" },
        peg$c57 = "Infinity",
        peg$c58 = { type: "literal", value: "Infinity", description: "\"Infinity\"" },
        peg$c59 = /^[+\-]/,
        peg$c60 = { type: "class", value: "[+-]", description: "[+-]" },
        peg$c61 = "0",
        peg$c62 = { type: "literal", value: "0", description: "\"0\"" },
        peg$c63 = /^[bB]/,
        peg$c64 = { type: "class", value: "[bB]", description: "[bB]" },
        peg$c65 = /^[01]/,
        ...
        peg$c71 = /^[0-9A-F]/,
        peg$c72 = { type: "class", value: "[0-9A-F]", description: "[0-9A-F]" },
        peg$c73 = /^[0-9]/,
    ...
    function peg$parsecomplex_selector() {
      var s0, s1, s2, s3, s4, s5, s6;

      s0 = peg$currPos;
      s1 = peg$parsecompound_selector();
      if (s1 !== peg$FAILED) {
        s2 = [];
        s3 = peg$currPos;
    ...
    function peg$parsetype_selector() {
      var s0, s1;
    ...
    function peg$parseIDENT_START() {
      ...
      if (s0 === peg$FAILED) {
        s0 = peg$parseUNICODE_Lu();
        if (s0 === peg$FAILED) {
          s0 = peg$parseUNICODE_Ll();
          if (s0 === peg$FAILED) {
            s0 = peg$parseUNICODE_Lt();
            if (s0 === peg$FAILED) {
              s0 = peg$parseUNICODE_Lm();
              if (s0 === peg$FAILED) {
                s0 = peg$parseUNICODE_Lo();
                if (s0 === peg$FAILED) {
                  s0 = peg$parseUNICODE_Nl();
                }
              }
            }
          }
    ...
    function peg$parseIDENT_NAME() {
      ...
      if (s0 === peg$FAILED) {
        ...
        if (s0 === peg$FAILED) {
          s0 = peg$parseUNICODE_Mn();
          if (s0 === peg$FAILED) {
            s0 = peg$parseUNICODE_Mc();
            if (s0 === peg$FAILED) {
              s0 = peg$parseUNICODE_Nd();
              if (s0 === peg$FAILED) {
                s0 = peg$parseUNICODE_Pc();
              }
            }
          }
        }
